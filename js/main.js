/**
 * Portfolio Main JavaScript - Modernized
 * AOS animations, skill bar animations, Poppins design system
 */
...
class SkillBarAnimator {
    ...
    init() {
        const bars = DOMUtils.$$('.skill-bar__fill');
...
class PortfolioApp {
    ...
    initializeManagers() {
        try {
            ...
            // Initialize AOS
            AOS.init({ easing: 'ease', duration: 400, once: true });
